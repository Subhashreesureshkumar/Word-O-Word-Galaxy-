...
public class level_2 implements ActionListener{
    ...
    { 
        ...
        l2=new JLabel("Hint:Most pleasing thing to be worn!!! check your hand for number of letters(@_@)");
        l2.setBounds(330,240,700,50);
        l2.setFont(ff);
        l2.setForeground(new Color(0,0,139));
        
        
        
        s=new JLabel(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\levelbackground.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(s7.getBackground().equals(Color.black) && s1.getBackground().equals(Color.black) && s13.getBackground().equals(Color.black) && s18.getBackground().equals(Color.black) && s6.getBackground().equals(Color.black) )
        {
            a.correct_music();
