...
public class level_1 extends MouseAdapter implements ActionListener{
    ...
    public level_1() 
    {
        ...
        l2=new JLabel(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\levelbackground.png"));
        ...
        //puzzle buttons
        b1=new JButton(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\b1.jpg"));
        ...
        prev=new JButton(new ImageIcon("prev_button.jpg"));
        prev.setBounds(120,475,145,30); 
        
        next=new JButton(new ImageIcon("next_button.jpg"));
        next.setBounds(690,475,145,30);
        next.setEnabled(false);
        
        home=new JButton(new ImageIcon("home_button.jpg"));
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        {
            b2.setIcon(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\b2.jpg"));
        }
        if(e.getSource().equals(b3))
        {
             b3.setIcon(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\b3.jpg"));
        }
        if(e.getSource().equals(b4))
        {
             b4.setIcon(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\b4.jpg"));
        }
        ...
        if(e.getSource().equals(b6))
        {
            ...
            i++;
                ...
                JOptionPane.showMessageDialog(null,"Chances are over(>_<)","Alert",JOptionPane.WARNING_MESSAGE);
