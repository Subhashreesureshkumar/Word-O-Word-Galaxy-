...
public class level_3 implements ActionListener{
    ...
    public level_3()
    {
        ...
        b1=new JButton(new ImageIcon("level3hint1.png"));
        b1.setBounds(300,300,200,200);
        
        b2=new JButton(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\level3hint2.png"));
        b2.setBounds(500,300,200,200);
        
        b3=new JButton(new ImageIcon("level3hint3.png"));
        b3.setBounds(700,300,200,200);
        
        b4=new JButton(new ImageIcon("level3hint4.png"));
