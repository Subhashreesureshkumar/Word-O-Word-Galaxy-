...
public class level_8 implements ActionListener{
     ...
     */
    JFrame f;
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,s;
    ...
    level_8()
    {
        ...
        s=new JLabel(new ImageIcon("level8_img.png"));
        ...
        l4.setForeground(new Color(0,0,139));
         ...
         l8=new JLabel(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\levelback8.png"));
        
        l8.setBounds(0,0,1386,1150);
        ...
        r4.setBounds(200,580,150,30);
        r4.setFont(ff);
        r5=new JRadioButton("Book");
        r5.setBounds(200,630,150,30);
        r5.setFont(ff);
        r6=new JRadioButton("Camera");
        r6.setBounds(200,680,150,30);
        r6.setFont(ff);
