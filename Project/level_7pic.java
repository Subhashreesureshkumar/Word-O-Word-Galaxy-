...
public class level_7pic implements ActionListener{
     ...
     */
     JFrame f;
     JLabel s,s1,l1,l2,l3,l4;
     JButton s6,s7,s8,s9,next,prev,home;
     int i=1;
     level_7pic()
     {
        f=new JFrame();
        s1=new JLabel(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\level7egyptpyramid.jpg"));
        s1.setBounds(400,300,500,500);
        
        Font ff=new Font("Georgia",Font.BOLD,16);
        Font f1=new Font("Didot",Font.BOLD+Font.ITALIC,32);
        
        s=new JLabel(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\level7audiopic.gif"));
        s.setBounds(100,50,200,200);
        
        JLabel s10 = new JLabel(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\level7playpic.gif"));
        ...
        l4=new JLabel(new ImageIcon("C:\\Users\\SUBHAHARINI\\Documents\\NetBeansProjects\\Word-O-Word Galaxy\\src\\Project\\levelbackground.png"));
